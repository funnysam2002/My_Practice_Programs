// fetch("http://api.openweathermap.org/geo/1.0/direct?q=londin&limit=1&appid=545024f0ea9acdf9948a6d7381ec0ba2")
// .then((res)=>{
...
//     const res = await fetch(`http://api.openweathermap.org/geo/1.0/direct?q=${city}&limit=1&appid=545024f0ea9acdf9948a6d7381ec0ba2`);
//     const data = await res.json();
//     const lat = await data[0].lat;
//     const lon = await data[0].lon;
//     const weatherReport = await fetch(`https://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${lon}&appid=545024f0ea9acdf9948a6d7381ec0ba2`);
//     const data1 = await weatherReport.json();
//     console.log(data1); 
